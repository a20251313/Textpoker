...
#if MODEFOR91
    NSString* message = [NSString stringWithFormat:@"玩扑克赢话费，还有这等好事存在？兄弟们速度来体验。下载地址：http://mobile.91.com/game/iPhone/category/cate_37/1_5.html"];
#else
    NSString* message = [NSString stringWithFormat:@"玩扑克赢话费，还有这等好事存在？兄弟们速度来体验。下载地址：http://www.o-popo.com/"];
#endif
    WBSendView *sendView = [[WBSendView alloc] initWithAppKey:appKey appSecret:appSecret text:message image:[UIImage imageNamed:@"bg.png"]];
