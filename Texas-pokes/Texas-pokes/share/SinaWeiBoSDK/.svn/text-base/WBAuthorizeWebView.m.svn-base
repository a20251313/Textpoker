...
- (id)init
{
    if (self = [super initWithFrame:CGRectMake(0, 0, 320, 480)])
    {
        ...
        UIButton  *btnClose = [[UIButton alloc] initWithFrame:CGRectMake(410, -5, 30, 30)];
        [btnClose setBackgroundImage:[UIImage imageNamed:@"close_btn@2x.png"] forState:UIControlStateNormal];
        [btnClose addTarget:self
                     action:@selector(closeWeiboWebView) forControlEvents:UIControlEventTouchUpInside];
...
- (void)closeWeiboWebView
{
    [[NSNotificationCenter defaultCenter] removeObserver:self name:@"remove_task_popView_from_window" object:nil];
